...
// import { ACCESS_SECRET_KEY, EMAIL } from "../../config/config.service.js";
...
// import { del, get, max_otp_key, otp_key, set } from "../../DB/redis/redis.service.js";
...
//              phone,
//               address, gender }: ISignUpType = req.body;
...
class UserService {
  ...
  private sendEmailOtp = async ({ email, subject }: { email: string; subject: EmailEnum }): Promise<void> => {
